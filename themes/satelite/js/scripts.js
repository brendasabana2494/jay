...
---------------------------------------------------*/
	...
	function PageLoad() {	
		...
		setTimeout(function(){
			...
			$('body').append('<audio loop autoplay volume="0" id="audio"><source src="https://b922bde52f23a8481830-83cb7d8d544f653b52d1a1621f05ea9d.mp3" type="audio/mpeg" /></audio>');
...
---------------------------------------------------*/	
	...
	function FirstLoad() {	
		...
		if ($("#page-content").hasClass("light-content")) {
			...
			if( $('#hero').length > 0 ){						
				if( $('#hero').hasClass("has-image")) {	
					$("header").css('background-color', 'rgba(64, 67, 61, 0.35)');
				} else {
